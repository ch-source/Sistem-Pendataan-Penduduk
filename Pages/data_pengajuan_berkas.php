<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Data Pengajuan Berkas</h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Data Pengajuan Berkas</li>
            </ol>
          </div>
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tabel Data Pengajuan Berkas</h6>
                </div>
                <div class="card-body">
                    ...
                    <thead class="thead-light">
                      <tr>
                        ...
                        <tbody>
                              ...
                              include"koneksi.php";
                              $no_a=1;
                              $query_a="SELECT * FROM tbl_penduduk_keluar WHERE status_pk=''";
                              ...
                              <tr>
                                ...
                                <td><?php 
                                if (  $data_a['status_pk']=='') {
                                echo"<a href='proses_validasi_pk.php?id=".$data_a['id_pk']."' class='btn btn-success btn-sm'>Validasi</a>";
                                }else{
                                  echo"";
                                }
