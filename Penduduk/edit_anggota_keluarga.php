<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
           <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Edit Data Anggota Keluarga</h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Edit Data Anggota Keluarga</li>
            </ol>
          </div>
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
              ...
              $query_warga="SELECT * FROM tbl_penduduk WHERE nik='$id' AND no_kk='".$data['no_kk']."'";
              $sql_warga=mysqli_query($connect, $query_warga);
              $data_warga=mysqli_fetch_array($sql_warga);

              ?>
                <div class="card-body">
                  <form method="post" name='autoSumForm' action="proses_edit_dak.php?id=<?php echo $id;?>" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">NO. KK</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="nk" readonly="readonly" value="<?php echo $data['no_kk'];?>">
                      </div>
                    ...
                    <label class="col-sm-2 col-form-label">Provinsi</label>
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_warga['nik'];?>" required="required"  name="nik">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama Lengkap</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_warga['nama'];?>" name="nama" required="required">
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" value="<?php echo $data_warga['tempat_lahir'];?>" name="tempat" required="required">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_warga['pekerjaan'];?>" name="pekerjaan" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_warga['kewarganegaraan'];?>" value="WNI" readonly="readonly" name="sk">
                      </div>
                    </div>
                    <div class="form-group row">
