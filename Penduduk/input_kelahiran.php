<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
           <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Input Data Kelahiran</h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Input Data Kelahiran</li>
            </ol>
          </div>
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
              ...
              ?>
                <div class="card-body">
                  <form method="post" name='autoSumForm' action="proses_simpan_data_kelahiran.php" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Bukti Keterangan Kelahiran</label>
                      <div class="col-sm-4">
                        <input type="file" class="form-control" name="nama_file" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
